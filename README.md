...
## 1. Cloning and installing this repository
...
After creating a working Python environment (see instructions below), use the following pip command inside the repository directory to [install](https://docs.python.org/3/installing/index.html),

python -m pip install -e .

## 2. Tested instructions for creating a Python environment compatible with the QI SDK

### 2.1. Beginner-friendly installation
